<?php
/**
 * Template para la tarjeta de un último producto
 * 
 * @package Illumina
...
<div class="product-card">
    <a href="<?php echo esc_url($product['url']); ?>" class="product-preview">
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="304" height="182" viewBox="0 0 304 182" fill="none">
            <path d="M0.435913 24.2051C0.435913 11.1768 10.9974 0.615356 24.0257 0.615356H279.974C293.003 0.615356 303.564 11.1768 303.564 24.2051V157.44C303.564 171.371 291.556 182.268 277.69 180.919L21.7418 156.021C9.65517 154.846 0.435913 144.686 0.435913 132.542V24.2051Z" fill="url(#pattern0_1527_801)" />
            <defs>
                ...
                <image id="image0_1527_801" width="2552" height="1439" xlink:href="<?php echo esc_url($product['image']); ?>" />
            </defs>
        </svg>
    </a>
    ...
    <div class="buy-product">
        <span class="price"><?php echo wp_kses_post($product['price']); ?></span>
        <?php 
